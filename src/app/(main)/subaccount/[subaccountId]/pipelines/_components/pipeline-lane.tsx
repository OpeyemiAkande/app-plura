            ...
            <AlertDialog>
              <DropdownMenu>
                <div className="bg-slate-200/30 dark:bg-background/20 h-[700px] w-[300px] px-4 relative rounded-lg overflow-visible flex-shrink-0">
                  ...
                  >
                    <div className="full flex items-center p-4 justify-between cursor-grab border-b-[1px]">
                      ...
                      <div className="flex items-center flex-row">
                        <Badge className="flex items-center flex-row">
                          {amt.format(laneAmt)}
                        </Badge>
                        <DropdownMenuTrigger>
                ...
                <AlertDialogContent>
                  ...
                  <AlertDialogFooter className="flex align-items-center">
